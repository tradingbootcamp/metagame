import { ApiAllLocationsResponse as ApiLocationsResponse } from '../../app/api/queries/locations/route'
import { ApiUserFullProfileResponse } from '../../app/api/queries/profiles/[userId]/route'
...
import { ApiUserRsvpsResponse } from '../../app/api/queries/rsvps/[userId]/route'
import { ApiCurrentUserRsvpsResponse } from '../../app/api/queries/rsvps/current/route'
import { ApiRsvpsResponse } from '../../app/api/queries/rsvps/route'
import { ApiUserSessionBookmarksResponse } from '../../app/api/queries/session-bookmarks/[userId]/route'
import { ApiCurrentUserSessionBookmarksResponse } from '../../app/api/queries/session-bookmarks/current/route'
import { ApiAllSessionBookmarksResponse } from '../../app/api/queries/session-bookmarks/route'
import { ApiSessionResponse } from '../../app/api/queries/sessions/[id]/route'
import { ApiAllSessionsResponse } from '../../app/api/queries/sessions/route'
