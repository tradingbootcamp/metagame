...
export const Hero: React.FC = () => {
  return (
    <section
      className="flex min-h-[80vh] flex-col items-center justify-center px-0 pt-4 pb-2 md:px-12 md:pt-0"
      id="hero"
    >
      <div className="flex max-w-prose flex-col items-center justify-center">
        ...
        <p className="mb-4 max-w-prose text-center text-lg font-black md:mb-8 md:text-xl">
          <span
      ...
      <div className="bg-opacity-50 mt-2 flex flex-col items-center rounded-lg bg-black p-6 md:mt-14 md:p-12">
        <div
